...
public class DungeonGame {
    ...
    public int calculateMinimumHP(int[][] dungeon) {
        ...
        while (!curr.princess()) {
            if (curr.right() != null) {
                pq.add(new GameState(curr, curr.cost + curr.right(), curr.x, curr.y + 1));
            }
            if (curr.down() != null) {
                pq.add(new GameState(curr, curr.cost + curr.down(), curr.x + 1, curr.y));
            }
            curr = pq.poll();
        }
        return nonNegative(curr.biggestCost) + 1;
    }
    ...
    public class GameState implements Comparable<GameState>{
        ...
        public GameState(int[][] board) {
            ...
            this.y = 0;
            this.cost = - board[0][0];
            this.biggestCost = this.cost;
        }

        public GameState(GameState prev, Integer cost, int x, int y) {
            this.board = prev.board;
            this.cost = cost;
            this.x = x;
            this.y = y;
            this.biggestCost = cost > prev.biggestCost ? cost : prev.biggestCost;
        }
